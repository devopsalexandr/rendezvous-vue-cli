<template>
    <div class="messaging">
        <div class="inbox_msg">
            ...
            <template v-if="conversation.messages && conversation.messages.length">
                <message-history :conversation="conversation"></message-history>
            </template>
            <template v-else>
                <div class="mesgs">
                    <div class="msg_history">
                        <p>Select one of conversations to start dialog</p>
                    </div>
                </div>
            </template>
